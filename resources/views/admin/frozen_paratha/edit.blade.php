    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            <div class="bg-light rounded p-4 shadow-sm">
                ...
                <form id="ckeditor" action="{{ route('admin.frozenParatha.update', $FrozenParathaProduct->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!-- Product No Field -->
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="product_no" class="form-control" id="product_no"
                                value="{{ old('product_no', $FrozenParathaProduct->product_no) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="product_name" class="form-control" id="product_name"
                                value="{{ old('product_name', $FrozenParathaProduct->product_name) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="product_description" class="form-control" id="product_description"
                                rows="3" required>{{ old('product_description', $FrozenParathaProduct->product_description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @if($FrozenParathaProduct->product_img)
                            <img src="{{ asset('Parathaproducts/' . $FrozenParathaProduct->product_img) }}" alt="Current Image" width="120" class="mt-2 rounded">
                            @endif
                        </div>
                    </div>
